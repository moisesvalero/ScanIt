...
const ru = {
  ...
  scanit: {
    header: {
      ...
      subtitle:
        "Проверяйте подлинность и происхождение файлов простым способом.",
    },
    badges: {
    ...
    main: {
      ...
      description:
        "Мы проверяем, создан ли документ человеком, анализируя его техническую историю и цифровые доказательства.",
    },
...
const ar = {
  ...
  scanit: {
    ...
    main: {
      title: "محلل الملفات",
      description:
        "نتحقق مما إذا كان المستند من إنشاء بشري عبر تحليل تاريخه التقني والأدلة الرقمية.",
    },
...
const hi = {
  ...
  scanit: {
    header: {
      ...
      subtitle:
        "अपने फ़ाइलों की प्रामाणिकता और स्रोत को सरल तरीके से सत्यापित करें।",
    },
    badges: {
      fileIdentity: "फ़ाइल पहचान",
      workTime: "कार्य समय",
      realData: "वास्तविक डेटा",
    },
    modules: {
      verifyDocument: "दस्तावेज़ सत्यापित करें",
      reviewCapture: "कैप्चर जाँचें",
    },
    main: {
      title: "फ़ाइल विश्लेषक",
      description:
        "हम तकनीकी इतिहास और डिजिटल साक्ष्यों का विश्लेषण करके जाँचते हैं कि दस्तावेज़ मानव द्वारा बनाया गया है या नहीं।",
    },
