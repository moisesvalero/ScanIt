...
<section class="statement">
  ...
  <div class="statement-inner">
    ...
    <div class="st-headline">
      <span class="st-line"
        ><span class="st-line-inner">{$t("usecases.line1")}</span></span
      >
      <span class="st-line"
      ...
      <span class="st-line" style="display:flex;align-items:baseline;gap:20px;">
        <span class="st-line-inner" style="color:rgba(26,26,46,0.25);"
          >{$t("usecases.line3")}</span
        >
...
<style>
  ...
  .st-eyebrow-line {
    width: 40px;
    height: 1.5px;
    background: linear-gradient(90deg, #7c5cbf, transparent);
    flex-shrink: 0;
  }
  .st-eyebrow-text {
    font-size: 11px;
  ...
  .st-gradient {
    background: linear-gradient(135deg, #7c5cbf 0%, #4f8ef7 50%, #7c5cbf 100%);
