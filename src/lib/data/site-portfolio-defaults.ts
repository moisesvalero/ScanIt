    ...
    items: [
      {
        icon: "🛒",
        title: "E-commerce",
        description: "Tiendas online orientadas a conversion.",
      },
      {
        icon: "🌐",
        title: "Desarrollo Web",
        description: "Sitios optimizados con SEO tecnico.",
      },
      {
        icon: "⚙️",
        title: "Soporte Tecnico IT",
        description: "Mantenimiento e incidencias IT.",
      },
    ],
  },
  techStack: {
    ...
    items: [
      {
        icon: "🚀",
        title: "Rendimiento",
        description: "Velocidad de carga real.",
      },
    ],
  },
  projects: {
